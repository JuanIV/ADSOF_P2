...
public class TestsCompatibilidadYDifusion {
	...
	static void testCompatibilidadLecturaEscritura() {
		try {
			...
			r1.guardarRedSocial("txt/usuarios1_2.txt", "txt/enlaces1_2.txt", "txt/mensaje1_2.txt");
			RedSocial r3 = new RedSocial("txt/usuarios1_2.txt", "txt/enlaces1_2.txt", "txt/mensaje1_2.txt", null);
	...
	static void testCompatibilidadYDifusionMensaje() {
		try {
			...
			r1.guardarRedSocial("txt/usuarios3.txt", "txt/enlaces3.txt", "txt/mensaje3.txt");
			System.out.println(r1);
			RedSocial r3 = new RedSocial("txt/usuarios3.txt", "txt/enlaces3.txt", "txt/mensaje3.txt", null);
